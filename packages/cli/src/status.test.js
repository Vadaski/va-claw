...
test("session append and recall commands use session journal deps", async () => {
  const entries = [
    { timestamp: "2026-03-12T10:00:00.000Z", role: "user", summary: "Asked for status" },
    { timestamp: "2026-03-12T10:01:00.000Z", role: "assistant", summary: "Summarized daemon state" }
  ];
  const deps = createTestDeps({
